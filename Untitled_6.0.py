...
data_dir="C:\\Users\\Vinayak\\Downloads\\pt\\CARLA_Latest\\WindowsNoEditor\\PythonAPI\\examples\\out\\model_imi\\"
...
#data_dir='/home/choyya/out/output_cam/'
#csv_path='/home/choyya/out/output_csv/img_seg_ctrl.csv'
...
#             row[0]=row[0][:2]+t1
#             if(row[0]+'.png' in img_name_list and row[3]==str(direction)):
...
#     checkpoint = ModelCheckpoint("/home/vinayakpc/chkpt/"+'model-{val_loss:03f}.h5',
#                                  monitor='val_loss',
#                                  verbose=0,
#                                  save_best_only=True,
#                                  mode='auto')
...
tf.keras.utils.plot_model(branches[0], to_file=data_dir+"my_model1.png", show_shapes=True)
tf.keras.utils.plot_model(branches[1], to_file=data_dir+"my_model2.png", show_shapes=True)
tf.keras.utils.plot_model(branches[2], to_file=data_dir+"my_model3.png", show_shapes=True)
tf.keras.utils.plot_model(branches[3], to_file=data_dir+"my_model4.png", show_shapes=True)
